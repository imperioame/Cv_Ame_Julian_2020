...
TRABAJOS.push(trabajo);
trabajo = new Trabajo('Qa Lead', "Argentina's National Ministry of Productive Development", 'General Direction of Information and Comunication Tecnologies', 'Quality Assurance team Leader in National-Public systems.<br> DDocumentation, manuals and process standards-and-definitions Consultor.<br> Sistems and documentation auditor and testing.<br>Team building and working methodologies Adviser.', '', 'june 2020', 'Present', 'eng');
TRABAJOS.push(trabajo);
trabajo = new Trabajo('Digital Products Manager', 'Fundación Landrú', '', 'Teams and Digital product developments Manager.<br>External teams and collaborators management.<br>Scope definition by multimedia or IT projects.<br>Technical feasibility analisys of proposals and projects.<br>Existant and proposed system funcionalities audit.<br>System design by surveying users and functionalities.<br>Prototyping and crude development as Proof of Concept for new proposals.','https://www.landru.org/', 'junio 2021', 'Present', 'eng');
TRABAJOS.push(trabajo);
