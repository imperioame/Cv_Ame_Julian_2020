...
DATOS_PERSONALES.push(dato);
dato = new Dato('titulo_destacado', 'Lic. Comunicación Digital', 'es');
DATOS_PERSONALES.push(dato);
dato = new Dato('titulo_destacado', 'Degree in Digital Communication', 'en');
DATOS_PERSONALES.push(dato);
dato = new Dato('profesion_destacada', 'Project Manager');
DATOS_PERSONALES.push(dato);
dato = new Dato('perfil_extracto', 'Diseñador Multimedial y líder de proyectos digitales. <br>Emprendedor y apasionado en la organización y organizaciones. <br>Técnico por naturaleza.', 'es');
DATOS_PERSONALES.push(dato);
dato = new Dato('perfil_extracto', 'Multimedia Designer and Digital PM.<br> Entrepreneur and passionate about organizations and organization.<br> Natural born technician.', 'en');
DATOS_PERSONALES.push(dato);


let educacion = new Educacion('Comunicación digital e interactiva', 'Pontífica Universidad Católica Argentina', 'Licenciatura.', 'marzo 2021', 'diciembre 2021', 'es');
...
educacion = new Educacion('Digital and Interactive Communication', 'Pontífica Universidad Católica Argentina', 'Bachelor degree', 'march 2021', 'december 2021',
    'en');
EDUCACION.push(educacion);
educacion = new Educacion('Diseño multimedial', 'Escuela DaVinci', 'Tecnicatura Superior en Diseño Multimedial orientado a publicidad.', 'marzo 2017', 'abril 2020', 'es');
EDUCACION.push(educacion);
educacion = new Educacion('Multimedia Design', 'Escuela DaVinci', 'Higher Technician in Multimedia design oriented to publicity.', 'march 2017', 'april 2020', 'en');
EDUCACION.push(educacion);
educacion = new Educacion('Diseño y Programación Web', 'Escuela DaVinci', 'Tecnicatura Superior en Diseño y Programación Web.', 'marzo 2020', ...Array(1), 'es');
EDUCACION.push(educacion);
educacion = new Educacion('Web Development and Design', 'Escuela DaVinci', 'Higher Technician in Web Development and Design.', 'march 2020', 'Present', 'en');
EDUCACION.push(educacion);


let competencia = new Competencia('Metodologías ágiles', 75, 'es');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Quality Assurance', 75);
COMPETENCIAS.push(competencia);
competencia = new Competencia('Modelado y animación 3D', 75, 'es');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Desarrollo Web', 50, 'es');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Diseño y retoque de imagen', 50, 'es');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Motion graphics', 50);
COMPETENCIAS.push(competencia);
competencia = new Competencia('Agile Methodologies', 75, 'en');
COMPETENCIAS.push(competencia);
competencia = new Competencia('3D Modeling and Animation', 75, 'en');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Web Development', 50, 'en');
COMPETENCIAS.push(competencia);
competencia = new Competencia('Design and Photo retouching', 50, 'en');
COMPETENCIAS.push(competencia);
